...
VALID_MODEL_FULL = {
    ...
    'fields': [
        # only field_map, no uid
        {'data_reference': '"campaign_id"', 'field_map': ['campaign_id'], 'data_type': 'CHARACTER VARYING',},
        # only uid, no field_map
        {'uid': 'sf.db.schema.table1.adset_id', 'data_reference': '"adset_id"', 'data_type': 'CHARACTER VARYING',},
        # has uid and field_map
        {
            'uid': 'sf.db.schema.table1.ad_id',
...
INVALID_MODELS = [
    ...
    # neither uid nor field_map set
    {**VALID_MODEL_MINIMAL, 'fields': [{'data_reference': '"campaign_id"', 'data_type': 'CHARACTER VARYING',},],},
    # data_type not set
    {**VALID_MODEL_MINIMAL, 'fields': [{'data_reference': '"campaign_id"', 'uid': 'sf.db.schema.table1',},],},
    # data_reference not set
    {**VALID_MODEL_MINIMAL, 'fields': [{'uid': 'sf.db.schema.table1', 'data_type': 'CHARACTER VARYING',},],},
]
